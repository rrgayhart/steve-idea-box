...
**Tutorial by [Steve Kinney](https://github.com/stevekinney/idea-box)**

[IdeaBox](README.md#idea-box)
- [Preamble](README.md#Preamble)
- [Getting Started](README.md#getting-started)
- [The Idea Model](README.md#the-idea-model)
    - [Quality Control](README.md#quality-control)
    - [Adding Validations](README.md#adding-validations)
- [Setting Up Our Controller](README.md#setting-up-our–controller)
- [Testing Our Controller Actions](README.md#testing-our-controller-actions)
    - [Testing the Index Action](README.md#testing-the-index-action)
    - [Drying Up Our Tests](README.md#drying-up-our-tests)
    - [Testing the Contents of Our Response](README.md#testing-the-contents-of-our-response)
    - [Getting a Specific Idea](README.md#getting-a-specific-idea)
    - [Creating New Ideas](README.md#creating-new-ideas)
    - [The Unhappier Side of Creating Ideas](README.md#the-unhappier-side-of-creating-ideas)
    - [Updating Ideas](README.md#updating-ideas)
    - [Changing the Quality of an Idea](README.md#changing-the-quality-of-an-idea)
    - [The Unhappy Path and Enum Edge Cases](README.md#the-unhappy-path-and-enum-edge-cases)
    - [The Rescue Mission](README.md#the-rescue-mission)
    - [Deleting an Idea](README.md#deleting-an-idea)
- [The Client Side](README.md#the-client-side)
    - [Generate a Static Page Controller](README.md#generate-a-static-page-controller)
    - [Getting the Basic Structure Up and Running](README.md#getting-the-basic-structure-up-and-running)
        - [Setting up Capybara](README.md#setting-up-capybara)
        - [Adding the Form and Ideas Container](README.md#adding-the-form-and-ideas-container)
    - [Testing Some JavaScript with Capybara](README.md#testing-some-javaScript-with-capybara)
- [Testing JavaScript](README.md#testing-javaScript)
    - [Adding an Idea](README.md#adding-an-idea)
        - [The hassles of Asynchronous Code and Multiple Threads](README.md#the-hassles-of-asynchronous-code-and-multiple-threads)
        - [Testing the Unhappy Path](README.md#testing-the-unhappy-path)
    - [Displaying Ideas](README.md#displaying-ideas)
    - [Adding the Ideas We Create to the Page](README.md#adding-the-ideas-we-create-to-the-page)
    - [Deleting Ideas](README.md#deleting-ideas)
        - [Testing the lack of an Unhappy Path](README.md#testing-the-lack-of-an-unhappy-path)
    - [Promoting and Demoting Ideas](README.md#promoting-and-demoting-ideas)
- [Towards an Object Oriented Approach](README.md#towards-an-object-oriented-approach)
